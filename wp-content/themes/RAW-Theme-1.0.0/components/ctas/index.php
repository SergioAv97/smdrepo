	...
	<div class="container">
		<ul class="grid">
			<li>
				<?php
				printf(
					'<a role="button" class="raw-whatsapp contrast" href="%s">%s</a>',
			...
			<li>
				<?php
				printf(
					'<a role="button" class="raw-tiktok contrast" href="%s">%s</a>',
			...
			<li>
				<?php
				printf(
					'<a role="button" class="raw-instagram contrast" href="%s">%s</a>',
