...
<div class="raw-component contrast hero-faqs">
	<div class="container">
		...
		<div>
			<div><?php print do_shortcode( wp_kses_post( get_post_meta( get_the_ID(), 'raw_hero-faqs_shortcode', true ) ) ?: '[trustindex data-widget-id=5efa14578871391257525a5454]' ); ?></div>
			<div>
			<?php
