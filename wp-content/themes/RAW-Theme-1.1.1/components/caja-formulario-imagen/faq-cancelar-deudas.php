<h2 class="big">Preguntas frecuentes sobre cancelar deudas</h2>
<ul class="accordion">
	<li>
		<input type="checkbox" class="hidden" id="raw_box-guides_title_1">
		<h3>
			<label for="raw_box-guides_title_1">¿Cómo puedo cancelar mi deuda?</label>
		</h3>
		<div>
	...
	<li>
		<input type="checkbox" class="hidden" id="raw_box-guides_title_2">
		<h3>
			<label for="raw_box-guides_title_2">¿Qué pasa si cancelo una deuda?</label>
		</h3>
		<div>
	...
	<li>
		<input type="checkbox" class="hidden" id="raw_box-guides_title_3">
		<h3>
			<label for="raw_box-guides_title_3">¿Quién puede cancelar una deuda?</label>
		</h3>
		<div>
...
<a role="button" class="raw-arrow-right" href="/preguntas-frecuentes-soluciona-mi-deuda/">Preguntas frecuentes</a>