			...
			<?php
				$posts = get_posts(
					array(
						...
						'numberposts'         => 4,
						'category'            => (int) esc_html( get_post_meta( get_the_ID(), 'raw_caja-imagen-texto_opiniones_category_id', true ) ) ?: 56, // Category: Opiniones.
						'orderby'             => 'date',
						'order'               => 'DESC',
					)
				);
					...
					array(
						...
						'tax_query'           => array(
							array(
								'taxonomy'         => 'post_tag',
								'field'            => 'term_id',
								'terms'            => (int) get_post_meta( get_the_ID(), 'raw_caja-imagen-texto_exitos_term_id', true ) ?: 55, // Term : Casos de éxito.
