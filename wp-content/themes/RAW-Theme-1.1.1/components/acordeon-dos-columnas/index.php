...
<div class="raw-component acordeon-dos-columnas">
	<div class="container">
		...
		<h2 class="big"><?php print wp_kses_post( get_post_meta( get_the_ID(), 'raw_acordeon-dos-columnas_title', true ) ) ?: '¿Quién puede acogerse a la Ley de Segunda Oportunidad?'; ?></h2>

		<div class="grid">
			<div>
				<h3><?php print wp_kses_post( get_post_meta( get_the_ID(), 'raw_acordeon-dos-columnas_col_1_title', true ) ) ?: 'Particulares y autónomos'; ?></h3>

				<?php
				print wp_kses_post( get_post_meta( get_the_ID(), 'raw_acordeon-dos-columnas_col_1_editor', true ) ) ?: '
				<ul class="accordion">
					<li>
						...
						<div>
							...
							<p>Si tu también te encuentras en esta situación, la Ley de la Segunda Oportunidad es el procedimiento idóneo para acabar de una vez con tus deudas.</p>
			...
			<div>
				<h3><?php print wp_kses_post( get_post_meta( get_the_ID(), 'raw_acordeon-dos-columnas_col_2_title', true ) ) ?: 'Requisitos'; ?></h3>
				<h4><?php print wp_kses_post( get_post_meta( get_the_ID(), 'raw_acordeon-dos-columnas_col_2_subtitle', true ) ) ?: 'Requisitos para acogerse a la Ley de la Segunda Oportunidad'; ?></h4>

				<?php
				print wp_kses_post( get_post_meta( get_the_ID(), 'raw_acordeon-dos-columnas_col_2_editor', true ) ) ?: '
				<ul class="accordion">
					<li>
